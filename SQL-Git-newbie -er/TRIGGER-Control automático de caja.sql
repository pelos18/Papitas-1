-- =====================================================
-- TRIGGER: Control automático de caja
-- Actualiza totales de caja con cada venta
-- =====================================================

PROMPT '🔥 Creando trigger para control de caja...'
...
PROMPT '✅ Trigger de control de caja creado exitosamente!'
