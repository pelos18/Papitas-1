-- =====================================================
-- TABLA FALTANTE: OFERTAS_ESPECIALES
-- Ofertas por categoría, happy hours, compra mínima
-- =====================================================
...
CREATE OR REPLACE TRIGGER TRG_OFERTAS_ESPECIALES_ID
    BEFORE INSERT ON OFERTAS_ESPECIALES
    FOR EACH ROW
BEGIN
    IF :NEW.id_oferta IS NULL THEN
        :NEW.id_oferta := SEQ_OFERTAS_ESPECIALES.NEXTVAL;
    END IF;
END;
/
